**Adrian Zhang's Stats Homework (4th Period)**
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="33.0827" data-t="2.2367" data-area="0.0322"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="497.3385" data-t="1.0646" data-area="0.2876"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="225.5522" data-t="-1.8116" data-area="0.0357"></div></div>
...
<div class="boxplot" data-min="59" data-q1="67.5" data-median="84.5" data-q3="92" data-max="100"></div></div>

<div class="boxplot" data-min="2" data-q1="40" data-median="60" data-q3="84" data-max="99"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="28.1193" data-t="3.3395" data-area="0.0012"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="214.8066" data-t="1.2317" data-area="0.1097"></div></div>
...
<div class="boxplot" data-min="0.9" data-q1="4.73" data-median="12.71" data-q3="19.095" data-max="27.43"></div></div>

`$$t = \frac{\bar{x} - H_0}{\frac{s}{\sqrt{n}}} = \frac{14.0789}{\frac{9.4745}{\sqrt{9}}}\\= 4.4576$$`

<div class="t-plot"><div class="plot" data-mean="0" data-df="8" data-t="4.4572" data-area="0.0011"></div></div>
...
<div class="boxplot" data-min="-336" data-q1="-180.5" data-median="-70" data-q3="-34" data-max="-5"></div></div>

`$$t = \frac{\bar{x} - H_0}{\frac{s}{\sqrt{n}}} = \frac{-105.27 - (-25)}{\frac{103.8450}{\sqrt{10}}}\\= -2.4575$$`

<div class="t-plot"><div class="plot" data-mean="0" data-df="9" data-t="-2.4575" data-area="0.0182"></div></div>
...
<div class="boxplot" data-min="-6.9" data-q1="-3.2" data-median="0.2" data-q3="2.6" data-max="2.7"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="7" data-t="-0.5916" data-area="0.5727"></div></div>
...
<div class="normal-plot"><div class="plot" data-mean="0" data-z="0.7676" data-area="0.4431"></div></div>
...
<div class="normal-plot"><div class="plot" data-mean="0" data-z="0.7051" data-area="0.4808"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="18.2663" data-t="-11.9523" data-area="0"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="10.4940" data-t="-68.8029" data-area="0"></div></div>
...
<div class="t-plot"><div class="plot" data-mean="0" data-df="17.7894" data-t="0.6977" data-area="0.4944"></div></div>
...
a. Let &mu;<sub>1</sub> be the true mean campus involvement reported by returning students and &mu;<sub>2</sub> be the true mean campus involvement reported by nonreturning students.
...
`$$t_\text{crit} = \text{invT}\left(\frac{1 - 0.95}{2}, df = 83.3559\right) = -1.9888$$`

`$$(\bar{x}_1 - \bar{x}_2) \pm t_\text{crit}\sqrt{\frac{s_1^2}{n_1} + \frac{s_2^2}{n_2}} = (0.3963, 1.2237)$$`

I am 95% confident that the difference between campus involvement reported by returning students and nonreturning students is between -0.5137 and 0.3138. Since this interval includes the point zero, it does not suggest that nonreturning students are less involved than returning students.

b. Let &mu;<sub>1</sub> be the true mean personal contact repoted by returning students and &mu;<sub>2</sub> be the true mean personal contact reported by nonreturning students.
...
*Assumptions*
* The samples are SRS.
* *n* > 30, so the sampling distribution will be normal per the Central Limit Theorem.
* *n*<sub>1</sub> and *n*<sub>2</sub> are less than 10% of the population.

`$$t = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{\frac{s_1^2}{n_1} + \frac{s_2^2}{n_2}}} = \frac{3.21-2.41}{\sqrt{\frac{0.93^2}{48} + \frac{1.03^2}{42}}}\\= 3.8936$$`

<div class="t-plot"><div class="plot" data-mean="0" data-df="83.3559" data-t="3.8936" data-area="0"></div></div>

Reject H<sub>0</sub> at &alpha; = 0.01. There is sufficient evidence to conclude that the mean personal contact of returning students is higher than the mean personal contact of non-returning students.