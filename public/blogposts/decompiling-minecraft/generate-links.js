...
const template = rows => `<!DOCTYPE html><head><meta charset="utf-8"><title>Minecraft Download Links</title><link rel="stylesheet" href="styles.css"></head><body><table><tr><th>Version</th><th>Client</th><th>Client Mappings</th><th>Server</th><th>Server Mappings</th></tr>${rows}</table></body></html>`;
